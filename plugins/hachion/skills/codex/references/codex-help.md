...
## Model Support (2026 Latest)

### Recommended Codex Models

| Model | Description | Best For |
|-------|-------------|----------|
| `gpt-5.2-codex` | Most advanced agentic coding model | Complex real-world engineering, security audits |
| `gpt-5.1-codex-max` | Long-horizon optimized | Multi-hour agent loops, project-scale refactors |
| `gpt-5.1-codex-mini` | Cost-effective version | Simple tasks, batch processing |
| `gpt-5.2` | General agentic model | Cross-domain tasks, research |

### Legacy Models (Still Available)

| Model | Status |
|-------|--------|
| `gpt-5.1-codex` | Superseded by max/mini versions |
| `gpt-5-codex` | Original version |
...
|-------|----------|------------|
| `xhigh` | Complex analysis, security audit | Highest |
| `high` | Standard analysis (default) | High |
| `medium` | Simple tasks | Medium |
| `low` | Trivial operations | Low |

**Note**: `xhigh` is supported by `gpt-5.2-codex`, `gpt-5.1-codex-max`, and `gpt-5.2`.
